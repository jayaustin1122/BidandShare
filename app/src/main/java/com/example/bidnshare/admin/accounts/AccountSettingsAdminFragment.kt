...
import com.example.bidnshare.databinding.FragmentAccountSettingsAdminBinding
...
class AccountSettingsAdminFragment : Fragment() {
    private lateinit var binding : FragmentAccountSettingsAdminBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAccountSettingsAdminBinding.inflate(layoutInflater)
